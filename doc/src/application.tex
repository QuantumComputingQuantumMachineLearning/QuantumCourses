...
national reearch and development priorities, yet currently lacks
...
\textit{Quantum Metrology and Sensing}, and \textit{Quantum Machine Learning}.

These courses are presently not offered at the graduate level at any
of the Norwegian institutions involed.  This program will thus provide
...
unified national strategy on eudcation in quantum technologies.
...
properly modularized, the material can be resued and tailored to
participants outside academia, such as public and private enterprises
which deal qith quantum technologies. Courses which target users from
...
All educational material will be freely availbale to students from all
...
similar content. Developing and tailoring the educational material to
