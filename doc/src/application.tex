...
The \textit{Quantum-TALENT} program aims at developing an advanced educational and training program in QIST. The program addresses central recommendations about QIST in Norway, as described in the recent evaluations of Natural Sciences and Mathematics in Norway \cite{evalnat,evalmat}. 
...
technology in Norway (EVALMIT), see \url{https://nifu.brage.unit.no/nifu-xmlui/bitstream/handle/11250/3189262/NIFUarbeidsnotat2025-6.pdf?sequence=1&isAllowed=y}
