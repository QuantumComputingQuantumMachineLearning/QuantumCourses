...
All courses correspond to 10 credits (ECTS). The courses are modularized, and if needed can be split into smaller modules of for example 5 credits. These courses will be offered in three cycles, with two courses per year, starting with course number 1 on quantum computing and then subsequently be followed by all other courses. One full cycle is thus 2.5-3 years. A PhD in Norway has a duration of three years and our program will thus be offered, in principle,  to three generations of PhD students. %However, as mentioned, some of them will be provided in sub-modules of less, typically 5, credits. And much of the content will also be adapted into summer/winter school teaching.
...
\end{itemize}
\end{comment}
\subsubsection{Course 4: Quantum Metrology and Sensing, 10 ECTS}
...
\end{itemize}
\end{comment}
\subsubsection{Course 5: Quantum Machine Learning, 10 ECTS}
...
The board 
%represents all involved institutions and 
is responsible for the overall success of the research school and the applications to the school. 
%Two of the enlisted PhD students will also be members of the board.
...
\bibitem{StM14}{Report No 14 to the Storting}, \url{https://www.regjeringen.no/en/dokumenter/meld.-st.-14-20222023/id2967608/}
...
\bibitem{skillsgap} See for example \url{https://www.mckinsey.com/featured-insights/mckinsey-explainers/what-is-quantum-computing}
...
\bibitem{Selsto2024}
		S. Selstø, \textit{A Computational Introduction to Quantum Physics}, Cambridge University Press, 2024.
